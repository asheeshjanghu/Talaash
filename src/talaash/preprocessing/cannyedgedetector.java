...
public class cannyedgedetector {
	...
	private void writeEdges(int pixels[]) {
        ...
        public  void viewedges(String args) throws IOException
        {
            String path=args;
        ...
        BufferedImage bie = ImageIO.read(new File(args)); 
        detector.setSourceImage(bie);
        detector.process();
        BufferedImage edges = detector.getEdgesImage();
        String edgesimagepath="C:/Users/asheesh/Documents/dataset//404JKL.jpg";
        ImageIO.write(detector.getEdgesImage(), "jpg", new File(edgesimagepath));
        ...
        System.out.println("path in edge view method ="+args);
                
        // for showing the image whose wavelet transformation we wish to see
        File  f=new File(edgesimagepath);
        ...
        shapeextractor seobj=new shapeextractor();
        
        String newpath="C:/Users/asheesh/Documents/dataset//shape1.jpg";
        seobj.extractshape(path,edgesimagepath);
        File  f2=new File(newpath);
        BufferedImage bi2=ImageIO.read(f2);
        
        JLabel imagelabel2=new JLabel();
        jtp.addTab("shape view", imagelabel2);
